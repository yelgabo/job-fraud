...
- web.applicationAddressType in {residential, po_box, virtual} → VERY STRONG fraud (+35 to +45): applicants are told to mail materials to a private home / PO box / virtual office rather than a real business address. This is one of the strongest fraud signals — on its own it should push a posting toward the HIGH band (>=70), and combined with mail_physical_resume it should land HIGH. "business" → mild legitimacy (-5); "none"/"uncertain" → neutral
